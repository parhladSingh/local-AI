  ...
  return (
    <Widget>
        ...
        <div className="flex bg-[#171717] rounded-[23px] p-[6px] gap-[6px]">
          {tabs.map((tab) => (
            <button
              ...
              className={`px-6 py-2.5 rounded-[16px] text-[16px] font-medium transition-all duration-300 ${activeTab === tab.id
                ? 'bg-[#28292F] text-white shadow-[13px_17px_67px_8px_rgba(0,0,0,0.25)_inset,0px_5px_12px_2px_rgba(255,255,255,0.15)_inset,0_0_40px_10px_rgba(0,0,0,0.5)]'
      ...
      <div className="relative">
        <div
          ref={contentRef}
          className="text-[#969696] text-[16px] font-normal leading-[25px] overflow-y-auto max-h-[175px] pr-3 custom-scrollbar"
        >
        ...
        <div className="absolute right-1 top-2 w-[8px] h-[64px] bg-gradient-to-b from-[#888989] to-[#4A4E54] rounded-full pointer-events-none"></div>
      </div>
